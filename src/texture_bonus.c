...
/*   Updated: 2025/01/08 23:57:03 by linyao           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
t_rgb mix_colors(t_rgb base_color, t_rgb texture_color, float mix_factor)
{
    ...
    res_color.r = (1 - mix_factor) * base_color.r + mix_factor * (base_color.r * texture_color.r / 255);
    res_color.g = (1 - mix_factor) * base_color.g + mix_factor * (base_color.g * texture_color.g / 255);
    res_color.b = (1 - mix_factor) * base_color.b + mix_factor * (base_color.b * texture_color.b / 255);
    if (res_color.r > 255) res_color.r = 255;
    if (res_color.g > 255) res_color.g = 255;
    if (res_color.b > 255) res_color.b = 255;
    return (res_color);
}
